        ...
        <div className={classes.footer}>
            <Container className={classes.inner}>
                ...
                <Group gap={0} className={classes.links} justify="flex-end" wrap="nowrap">
                    ...
                    <ActionIcon component={Link} href="https://www.youtube.com/@note-sounds" target="_blank" size="lg"
                                color="gray" variant="subtle">
                        <IconBrandYoutube style={{width: rem(18), height: rem(18)}} stroke={1.5}/>
                    </ActionIcon>
                    <ActionIcon component={Link} href="https://google.com" target="_blank" size="lg" color="gray"
                                variant="subtle">
                        <IconBrandSoundcloud style={{width: rem(18), height: rem(18)}} stroke={1.5}/>
                    </ActionIcon>
                    <ActionIcon component={Link} href="https://google.com" target="_blank" size="lg" color="gray"
                                variant="subtle">
